    ...
    <div className="min-h-screen animate-fade-in py-8 " data-theme="">
      <div className="flex flex-wrap gap-2 w-full">
        <Link href="" style={{ filter: "brightness(120%)" }} aria-label="Projects Section">
          <div className=" max-w-[40rem] md:ml-56 m-4 mb-10">
            <Image
              src={image1}
              alt="ykck"
              height={520}
            ...
            <div className="flex flex-wrap text-lg mt-2">
              <p className="flex-1 text-left">YKCK</p>
              <p className="flex-1 text-right">2023</p>
            </div>
            <p className="flex-1 text-left mt-1 text-zinc-400">F&B</p>
          </div>
        </Link>
        <Link href="" aria-label="Projects Section">
          ...
          >
            ...
            />
            <div className="flex flex-wrap text-lg mt-2">
              <p className="flex-1 text-left">Terrace Man Cave</p>
              <p className="flex-1 text-right">2021</p>
            </div>
            <p className="flex-1 text-left mt-1 text-zinc-400">Residential</p>
          </div>
        </Link>
        <Link href="" style={{ filter: "brightness(140%)" }} aria-label="Projects Section">
          <div className=" max-w-[40rem] md:ml-80 md:-mt-40 m-4 mb-10">
            <Image
              src={image3}
              alt="Moksha Bar"
              height={420}
            ...
            />
            <div className="flex flex-wrap text-lg mt-2">
              <p className="flex-1 text-left ">Moksha Bar</p>
              <p className="flex-1 text-right">2022</p>
            </div>
            <p className="flex-1 text-left mt-1 text-zinc-400">F&B</p>
          </div>
        </Link>
      ...
      <div className="flex flex-wrap gap-2 w-full mx-auto justify-center align-center">
        <Link href="" aria-label="Projects Section">
          <div
            className="  mx-auto md:mt-20 m-4 mb-10 w-full"
            style={{ filter: "brightness(120%)" }}
          >
            <Image
              src={image4}
            ...
            />
            <div className="flex flex-wrap text-lg mt-2">
              <p className="flex-1 text-left">Sports One</p>
              <p className="flex-1 text-right">2022</p>
            </div>
            <p className="flex-1 text-left mt-1 text-zinc-400">Retail</p>
          </div>
        </Link>
      </div>
      <div className="flex flex-wrap gap-2  ">
        <Link href="" style={{ filter: "brightness(140%)" }} aria-label="Projects Section">
          <div className=" max-w-[40rem] md:ml-40  m-4 mb-10">
            ...
            />
            <div className="flex flex-wrap text-lg mt-2">
              <p className="flex-1 text-left ">Grand Entrance</p>
              <p className="flex-1 text-right">2022</p>
            </div>
            <p className="flex-1 text-left mt-1 text-zinc-400">Conceptual</p>
          </div>
        </Link>
        <Link href="" style={{ filter: "brightness(140%)" }} aria-label="Projects Section">
      ...
      <div className="flex flex-wrap gap-2 justify-start w-full ">
        <Link href="" style={{ filter: "brightness(90%)" }} aria-label="Projects Section">
          <div className="max-w-[40rem] m-4 mb-10 md:ml-52 md:-mt-80">
            <Image
              src={image8}
              alt="Visore Opticals"
              height={680}
            ...
            />
            <div className="flex flex-wrap text-lg mt-2">
              <p className="flex-1 text-left">Visore Opticals</p>
              <p className="flex-1 text-right">2023</p>
            </div>
            <p className="flex-1 text-left mt-1 text-zinc-400">Retail</p>
          </div>
      ...
      <div className="flex flex-wrap gap-2 justify-end w-full ">
        <Link href="" style={{ filter: "brightness(115%)" }} aria-label="Projects Section">
          <div className="max-w-[40rem] m-4 mb-10  md:mt-1 md:mr-28 justify-end">
            ...
            />
            <div className="flex flex-wrap text-lg mt-2">
              <p className="flex-1 text-left">Delphi Derma Clinic</p>
              <p className="flex-1 text-right">2023</p>
            </div>
            <p className="flex-1 text-left mt-1 text-zinc-400">Health Care</p>
          </div>
        </Link>
      </div>
      <div className="flex flex-wrap gap-2 justify-start w-full ">
        <Link href="" style={{ filter: "brightness(130%)" }} aria-label="Projects Section">
          <div className="max-w-[40rem] m-4 mb-10  md:mt-1 md:ml-80 ">
            ...
            />
            <div className="flex flex-wrap text-lg mt-2">
              <p className="flex-1 text-left">AR Rahman Cafe</p>
              <p className="flex-1 text-right">2021</p>
            </div>
            <p className="flex-1 text-left mt-1 text-zinc-400">F&B</p>
          </div>
      ...
      <Link href="" style={{ filter: "brightness(130%)" }} aria-label="Projects Section">
          <div className="max-w-[40rem] m-4 mb-10  md:mt-28 md:mr-60">
            ...
            />
            <div className="flex flex-wrap text-lg mt-2">
              <p className="flex-1 text-left">DUPLEX RESIDENCE</p>
              <p className="flex-1 text-right">2022</p>
            </div>
            <p className="flex-1 text-left mt-1 text-zinc-400">Residential</p>
          </div>
