...
const Nav = () => {
  ...
  return (
    ...
    >
      <div className="flex md:ml-20 ml:0 lg:flex-col gap-8 bg-zinc-300 border-2 border-indigo-600 p-4 justify-center items-center text-2xl rounded-full">
          ...
          return (
            ...
            >
              <div className="absolute left-20 hidden xl:group-hover:flex">
                <div className="bg-zinc-900 text-primary ml-2 text-[12px] p-[0.5rem] rounded-[0.5rem] relative leading-none capitalize">
                  {link.name}
                </div>
